...
public class VolleyLog {
	...
	public static void setTag(String tag) {
		...
		VolleyConfig.TAG = tag;

		// Reinitialize the DEBUG "constant"
		VolleyConfig.DEBUG = Log.isLoggable(VolleyConfig.TAG, Log.VERBOSE);
	}

	public static void v(String format, Object... args) {
		if (VolleyConfig.DEBUG) {
			Log.v(VolleyConfig.TAG, buildMessage(format, args));
		}
	}

	public static void d(String format, Object... args) {
		Log.d(VolleyConfig.TAG, buildMessage(format, args));
	}

	public static void e(String format, Object... args) {
		Log.e(VolleyConfig.TAG, buildMessage(format, args));
	}

	public static void e(Throwable tr, String format, Object... args) {
		Log.e(VolleyConfig.TAG, buildMessage(format, args), tr);
	}

	public static void wtf(String format, Object... args) {
		Log.wtf(VolleyConfig.TAG, buildMessage(format, args));
	}

	public static void wtf(Throwable tr, String format, Object... args) {
		Log.wtf(VolleyConfig.TAG, buildMessage(format, args), tr);
	}
	...
	static class MarkerLog {
		public static final boolean ENABLED = VolleyConfig.DEBUG;
		/**
