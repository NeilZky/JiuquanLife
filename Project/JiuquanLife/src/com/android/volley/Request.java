...
public abstract class Request<T> implements Comparable<Request<T>> {
	...
	private final MarkerLog mEventLog = MarkerLog.ENABLED
			? new MarkerLog()
			: null;
	...
	protected String getParamsEncoding() {
		return VolleyConfig.DEFAULT_PARAMS_ENCODING;
	}

	public String getBodyContentType() {
		return VolleyConfig.DEFAULT_CONTENTTYPE + getParamsEncoding();
	}
