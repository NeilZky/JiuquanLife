...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
		...
		tabTextColor = a.getColor(R.styleable.PagerSlidingTabStrip_pstsTextDefalutColor, tabTextColor);
		tabTextSelectColor = a.getColor(R.styleable.PagerSlidingTabStrip_pstsTextSelectedColor, tabTextSelectColor);
	...
	private void scrollToChild(int position, int offset) {
		...
		if(v instanceof TextView) {
			((TextView) v).setTextColor(tabTextSelectColor);
		}
