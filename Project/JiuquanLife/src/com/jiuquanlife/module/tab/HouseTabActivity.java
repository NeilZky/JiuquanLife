...
public class HouseTabActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mTabHost.setup(this, getSupportFragmentManager(),
				R.id.fl_content_navtab);
		// View focusIndicator =
		// getLayoutInflater().inflate(R.layout.indicator_focus, null);
		...
		View houseIndicator = getLayoutInflater().inflate(
				R.layout.indicator_house, null);
		mTabHost.addTab(
				mTabHost.newTabSpec(HouseFragment.class.getSimpleName())
						.setIndicator(houseIndicator), HouseFragment.class,
				null);
		View publishHouseIndicator = getLayoutInflater().inflate(
				R.layout.indicator_house_publish, null);
		mTabHost.addTab(
				mTabHost.newTabSpec(
						PublishHouseTypeFragment.class.getSimpleName())
						.setIndicator(publishHouseIndicator),
				PublishHouseTypeFragment.class, null);
		// View communityIndicator =
		// getLayoutInflater().inflate(R.layout.indicator_forum, null);
		...
		View houseMineIndicator = getLayoutInflater().inflate(
				R.layout.indicator_house_mine, null);
		mTabHost.addTab(
				mTabHost.newTabSpec(HouseMineFragment.class.getSimpleName())
						.setIndicator(houseMineIndicator),
