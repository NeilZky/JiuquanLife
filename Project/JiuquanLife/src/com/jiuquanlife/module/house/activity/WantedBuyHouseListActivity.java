...
import com.jiuquanlife.vo.house.out.GetBuyHouseListOut;

public class WantedBuyHouseListActivity extends BaseHouseListActivity {
...
//		expandTabView = (ExpandTabView) findViewById(R.id.etv_secondary_house);
		...
		tv_title_house_list.setText("房屋求购");
	...
	private OnItemClickListener onItemClickListener = new OnItemClickListener() {
		...
		public void onItemClick(AdapterView<?> parent, View view, int position,
			...
			Intent intent = new Intent(WantedBuyHouseListActivity.this, WantedBuyHouseDetailActivity.class);
			intent.putExtra(WantedBuyHouseDetailActivity.INTENT_KEY_HOUSE_ID, houseItem.houseid);
	...
	private void getData() {
		...
		GetBuyHouseListOut out =new GetBuyHouseListOut();
		out.actionRelation = "4";
		out.actionType = actionType;
		RequestHelper.getInstance().getRequestEntity(WantedBuyHouseListActivity.this,
				"http://www.5ijq.cn/App/House/getWantedByHouseList", out,
				new Listener<String>() {
	...
	private void onRefresh(View view, String showText) {
		...
		Toast.makeText(WantedBuyHouseListActivity.this, showText,
