...
public class PublishSearchActivity extends Activity {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1,
				...
				SharePreferenceHelp.getInstance(getApplicationContext())
						.saveSearchHistory(search,
								SharePreferenceHelp.PUBLISH_SEARCH_HISTORY);
				Intent intent = new Intent(PublishSearchActivity.this,
	...
	private void initSearchHistory() {
		...
		final SearchHistoryAdapter searchHistoryAdapter = new SearchHistoryAdapter(
				searchHistory, PublishSearchActivity.this);
...
//				}
	...
	private void loadData() {
		RequestHelper.getInstance().getRequest(getApplicationContext(),
				Common.PUBLISH_HOT_SEARCH, new Listener<String>() {
