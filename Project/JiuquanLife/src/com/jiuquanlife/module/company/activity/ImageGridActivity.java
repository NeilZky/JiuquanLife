...
import com.jiuquanlife.module.company.activity.ImageGridAdapter.TextCallback;
import com.jiuquanlife.module.love.UserSelftGalleryActivity;
		...
		public void handleMessage(Message msg) {
			...
			case 0:
				Toast.makeText(ImageGridActivity.this,
						"最多选择" + Bimp.IMG_SZIE + "张图片", 400).show();
				break;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		bt.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (Bimp.act_bool) {
					Intent intent = null;
					if (Bimp.FROM_WHERE.equals("Publish")) {
						intent = new Intent(ImageGridActivity.this,
								PublishInfoActivity.class);
					} else if (Bimp.FROM_WHERE
							.equals("UserSelftGalleryActivity")) {
						intent = new Intent(ImageGridActivity.this,
