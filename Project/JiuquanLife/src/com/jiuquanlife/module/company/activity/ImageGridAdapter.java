...
import com.jiuquanlife.module.company.activity.BitmapCache.ImageCallback;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		holder.iv.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if ((Bimp.drr.size() + selectTotal) < Bimp.IMG_SZIE) {
				...
				} else if ((Bimp.drr.size() + selectTotal) >= Bimp.IMG_SZIE) {
